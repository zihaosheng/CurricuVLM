    ...
    def _state_check(self):
        ...
        for contact in result_1.getContacts() + result_2.getContacts():
            ...
            # they work with the function in collision_callback.py to double-check the collision
                ...
                obj_0 = get_object_from_node(node0)
                obj_1 = get_object_from_node(node1)
                if obj_0.id != "default_agent":
                    self.crash_vehicle = obj_0.id
                elif obj_1.id != "default_agent":
                    self.crash_vehicle = obj_1.id
                else:
