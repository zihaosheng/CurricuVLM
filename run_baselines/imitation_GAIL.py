...
if __name__ == "__main__":
    ...
    logger = SafeLogger(exp_name='imitation-GAIL', env_name=args.env, seed=args.seed,
    ...
    for i in range(100):
        ...
        if args.save_model: learner.save(os.path.join(logger.log_dir, "{}-{}".format("imitation-GAIL", i)))
