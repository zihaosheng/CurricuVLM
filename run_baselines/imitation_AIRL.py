...
if __name__ == "__main__":
    ...
    logger = SafeLogger(exp_name='imitation-AIRL', env_name=args.env, seed=args.seed,
    ...
    for i in range(100):
        ...
        eval_episode_overtake_adv = eval_policy(learner, eval_env, adv_generator, record_t=i)
        ...
        if args.save_model: learner.save(os.path.join(logger.log_dir, "{}-{}".format("imitation-AIRL", i)))
