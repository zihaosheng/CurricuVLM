...
class SafetyMetaDriveEnv(CMDP):
    ...
    def __init__(
        ...
        **kwargs: Any,  # pylint: disable=unused-argument
        ...
        if META_DRIVE_AVAILABLE:
            self._env = WaymoEnv(config=kwargs.get('meta_drive_config'))
        else:
            raise ImportError(
        ...
        self._action_space = convert_gym_to_gymnasium(self._env.action_space)
        self._observation_space = convert_gym_to_gymnasium(self._env.observation_space)
        print(self._action_space)
        print(type(self._action_space))
    ...
    def reset(
        ...
        Returns:
            ...
            info: Some information logged by the environment.
        """
        if self._env.engine is not None:
            self.last_seed = self._env.current_seed
